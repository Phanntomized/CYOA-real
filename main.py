...
def world2():
       ...
       def blackjack():
              ...
              bust = 0
              round = 1
              print_with_delay(Colors.GREEN + "Round 1")
              while new_game != True:
                     ...
                     if opnum == 11:
                            ...
                            opname2 = "an ace"
                     print_with_delay(Colors.GREEN + "You get dealt 2 cards.")
                     time.sleep(3)
                     print_with_delay(f"Your card's values are {name1} and {name2}, and your total is {total}.")
                     time.sleep(3)
                     ...
                     while round_over != True:
                            ...
                            if optotal > 21:
                                   ...
                                   print_with_delay(f"Your opponent has stood with {optotal}")
                                   time.sleep(3)
                            if total <= 21 and optotal <= 21:
                                   if optotal > total:
                                          ...
                                          print_with_delay("You have a higher value than your opponent, so you win the round.")
                                          time.sleep(3)
                                          bust += 1
                                          break
                     ...
                     if bust <= 3:
                            round += 1
                            print_with_delay(f"Round {round}.")
                            time.sleep(3)
                            continue
                     else:
                            print_with_delay("You lost and were thrown out fo the casino.")
                            time.sleep(3)
                            return "lost"
